...
jQuery.fn.pano = function(options) {
    ...
    //Changed mouse down to mouseover otherwise this conflicts with focusin
	...
	/*
	Added click event for keyboard and aria-pressed after changing <a href to a native button in HTML
